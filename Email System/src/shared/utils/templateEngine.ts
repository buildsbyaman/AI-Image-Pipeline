...
/**
 * Reads a template file and injects the provided variables.
 * @param templateName The name of the template (without extension).
 * @param type 'html' or 'txt' to specify the format.
 * @param variables Object containing the variables to inject.

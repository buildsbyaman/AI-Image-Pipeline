...
export function StatusBadge({ status }: StatusBadgeProps) {
  const statusConfig = {
    ...
    w1: { label: "Worker 1 Done", dotClass: "bg-indigo-400 animate-pulse", textClass: "text-indigo-400", borderClass: "border-indigo-500/20 bg-indigo-500/5" },
    w2: { label: "Worker 2 Done", dotClass: "bg-purple-400 animate-pulse", textClass: "text-purple-400", borderClass: "border-purple-500/20 bg-purple-500/5" },

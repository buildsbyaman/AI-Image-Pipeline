...
export function LoginForm({ onSubmit, onNavigateToOtp, isLoading }: LoginFormProps) {
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <button 
            type="button" 
            onClick={() => {
              console.log("Login: Forgot password click, navigating to OTP")
              onNavigateToOtp()
            }}
            className="text-xs text-[#A1A1AA] hover:text-[#FAFAFA] hover:underline transition-colors focus:outline-none"
          >
            Forgot password?
          </button>
        </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="text-center mt-1">
          <button
            ...
            disabled={isLoading}
            className="text-xs text-zinc-400 hover:text-white transition-colors hover:underline focus:outline-none"
          >
